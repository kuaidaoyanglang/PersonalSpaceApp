...
// </copyright>
//-----------------------------------------------------------------------
namespace ConferenceCommon.WPFControl.WindowSetting
{
              ...
              try
            {
                switch (msg)
                {
                    ...
                    case WMWINDOWPOSCHANGING:
                        ...
                        // 在将要改变的时候，是样式添加系统菜单
                        NativeMethods.SetWindowLong(hwnd, NativeMethods.GWL_STYLE, (int)oldstyle & ~(int)NativeMethods.WS_CAPTION | (int)NativeMethods.WS_SYSMENU);
                        break;
                }
            }
            catch (Exception ex)
